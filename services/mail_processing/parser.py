...
class Parser:
    ...
    def parse_data(self, print_data: bool = False) -> Dict[str, Any]:
        ...
        # Regex matching for various fields
        ...
        guest_location_match = guest_location_regex.search(self.message_body)
        ...
        if print_data:
            not_found_fields = {
                ...
                "guest_location_match": guest_location_match
            }
...
if __name__ == "__main__":
    # Sample message body for testing (French and English samples)
